...
public final class ViewfinderView extends View {
    ...
    private void initInnerRect(Context context, AttributeSet attrs) {
        ...
        // 扫描框边角颜色
        innercornercolor = ta.getColor(R.styleable.ViewfinderView_inner_corner_color, Color.parseColor("#ef1428"));
        // 扫描框边角长度
    ...
    private void drawFrameBounds(Canvas canvas, Rect frame) {
        ...
        paint.setColor(Color.parseColor("#ef1428"));
        canvas.drawText("扫描桌面学习系统登陆", getScreenWidth() / 2, frame.bottom + 200, paint);
        canvas.drawText("扫描试卷上二维码查看答案", getScreenWidth() / 2, frame.bottom + 270, paint);
    }
